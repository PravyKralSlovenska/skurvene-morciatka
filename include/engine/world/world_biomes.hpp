...
/*
 * BIOME
 * - kazdy biome ma svoj vlastny cave noise
 */
struct Biome
{
    Biome_Type type;
...
struct Biome_Blend
{
    Biome primary;
    Biome secondary;
    float blend_factor; // 0.0 naplno primary 1.0 naplno secondary
};
...
{
    return Biome(Biome_Type::STONE, 0.05f, 0.004f, 10.0f, Particle_Type::STONE);
}
...
{
    return Biome(Biome_Type::URANIUM, 0.09f, 0.005f, 30.0f, Particle_Type::URANIUM);
}
